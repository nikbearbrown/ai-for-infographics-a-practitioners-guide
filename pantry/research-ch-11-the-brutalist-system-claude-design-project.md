# Research: Chapter 11 — The Brutalist System: CLAUDE.md, DESIGN.md, PROJECT.md
## Brutalist SVG x Claude: Infographic Design and AI-Assisted Production

**Chapter one-line:** Students learn the three governing files that define all production before any code is written, and why the phase gate is an enforcement mechanism, not a suggestion.
...
### What is settled
Generated code behaves better when governed by explicit project instructions, design rules, and state files before execution. Relevant sources for this settled ground include Anthropic, D3 Team, Sculley et al..

### What is disputed
Claude Code behavior and best practices change quickly; fixed prompts may decay. The chapter should distinguish evidence-based design rules from local editorial judgment, especially when examples depend on audience, medium, or toolchain.

### What has changed recently (last 5 years)
Claude Code and agentic coding tools are changing rapidly; course materials must be checked before each offering. High-risk operational details include Claude Code behavior, D3 examples, WCAG guidance, Illustrator import behavior, and Node/SVG conversion scripts; these should be verified immediately before publication or course use.
...
- **Grace Hopper.** Substantive connection: directly connected to governing files and phase-gated AI production through visual communication, design systems, information graphics, computing, or production practice. Selection fit: historically meaningful and Wikipedia-accessible; verify exact page title before final Wayback pass. Example prompt: "Explain how Grace Hopper's work helps an engineer avoid a polished but indefensible infographic."
- **Douglas Engelbart.** Substantive connection: offers a complementary lineage for this chapter's principle, especially the relation between visual form and human interpretation. Selection fit: useful for balancing discipline or era. Example prompt: "Connect Douglas Engelbart to one design decision in a Brutalist SVG infographic."
- **Margaret Hamilton.** Substantive connection: gives an alternate anchor if the chapter needs a more visual, computational, or editorial figure. Selection fit: check diversity balance across the whole book before selection. Example prompt: "Show how Margaret Hamilton's work anticipates the design intelligence layer this chapter teaches."
...
Teach this chapter through failure-first comparison. The target reader can already ask an AI tool to produce SVG, so the instructional sequence should begin with a plausible AI-generated or professionally polished failure, then name the principle that explains the failure, then rebuild the artifact under constraint. Common misconceptions: polish equals correctness, prompts replace design specifications, and AI output can be judged by appearance alone. Students understand governing files and phase-gated AI production when they can defend a design choice in language that survives a skeptical review, not when they can merely reproduce a pretty result.
